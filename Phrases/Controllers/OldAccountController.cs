...
namespace Phrases.Controllers
{
    ...
    public class OldAccountController : Controller
    {
        ...
        public OldAccountController(ApplicationUserManager userManager, ApplicationSignInManager signInManager )
        {
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            switch (result)
            {
                ...
                default:
                    ModelState.AddModelError("", "Could not log in using the supplied Email and Password.");
                    return View(model);
            }
        }
